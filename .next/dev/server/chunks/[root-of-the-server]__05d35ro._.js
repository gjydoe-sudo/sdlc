...
"[project]/app/api/subtasks/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
async function getSubtaskForUser(id, userId) {
    const subtask = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["subtaskDB"].findById(id);
    if (!subtask) return null;
    const todo = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["todoDB"].findById(subtask.todo_id);
...
async function PUT(request, { params }) {
    ...
    if (!subtask) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
    ...
    try {
        ...
        const updated = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["subtaskDB"].update(parseInt(id), body);
...
async function DELETE(_request, { params }) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["subtaskDB"].delete(parseInt(id));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05d35ro._.js.map