...
;
;
function calcNextDueDate(dueDate, pattern) {
...
async function GET(_request, { params }) {
    ...
    const todo = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["todoDB"].findById(parseInt(id));
...
async function PUT(request, { params }) {
    ...
    const todo = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["todoDB"].findById(todoId);
    if (!todo || todo.user_id !== session.userId) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Todo not found'
        }, {
    ...
    try {
        ...
        if (updateData.completed === 1 && todo.completed === 0 && todo.is_recurring && todo.due_date && todo.recurrence_pattern) {
            ...
            const existingSubtasks = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["subtaskDB"].findByTodoId(todoId);
            const existingTags = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tagDB"].findByTodoId(todoId);
            const newTodo = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["todoDB"].create({
            ...
            for (const sub of existingSubtasks){
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["subtaskDB"].create({
                    todo_id: newTodo.id,
                    title: sub.title
                });
            }
            if (existingTags.length > 0) {
                __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tagDB"].setTodoTags(newTodo.id, existingTags.map((t)=>t.id));
            }
        }
        // Update tag assignments if provided
        if (Array.isArray(tag_ids)) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tagDB"].setTodoTags(todoId, tag_ids);
        }
        const updated = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["todoDB"].update(todoId, updateData);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...updated,
            subtasks: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["subtaskDB"].findByTodoId(todoId),
            tags: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tagDB"].findByTodoId(todoId)
        });
    } catch (error) {
...
async function DELETE(_request, { params }) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["todoDB"].delete(parseInt(id));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        success: true
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0rote10._.js.map