...
async function GET() {
    ...
    try {
        ...
        const tags = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tagDB"].findByUserId(session.userId);
        const exportData = {
            version: 1,
            ...
            todos: todos.map((todo)=>({
                    ...
                    tags: __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["tagDB"].findByTodoId(todo.id).map((t)=>t.name)
                })),
            tags
        };
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](JSON.stringify(exportData, null, 2), {
            headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0e-_4xw._.js.map